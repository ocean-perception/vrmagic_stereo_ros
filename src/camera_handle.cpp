...
namespace Driftcam
{
    ...
    /**
     * @brief Construct a new Camera Handle:: Camera Handle object
     *
     * @param camera_serial
     */
    ...
    /**
     * @brief Open a VRmagic device camera
     *
     * @param p_device_key Device key pointer
     * @param p_device_str Device string pointer
     */
    ...
    /**
     * @brief Stops the camera grabber
     * 
     */
    ...
    /**
     * @brief Closes the camera handle
     * 
     */
    ...
    /**
     * @brief Triggers a new frame grab
     * 
     */
    ...
    /**
     * @brief Grabs a new frame
     * 
     * @return int Number of frames available in the buffer
     */
