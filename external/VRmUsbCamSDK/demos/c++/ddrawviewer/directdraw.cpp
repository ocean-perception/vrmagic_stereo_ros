...
bool DDrawChangeBufferSize(VRmImageFormat f_format) {
	...
	g_bufferwidth = f_format.m_width;
	g_bufferheight = f_format.m_height;
	...
	descriptor.dwWidth = f_format.m_width;
	descriptor.dwHeight = f_format.m_height;
...
bool DDrawOpen(const char *title, VRmImageFormat f_format)
{
	...
	rect.left = 0;
	rect.top = 0;
	rect.right = f_format.m_width;
	rect.bottom = f_format.m_height;
